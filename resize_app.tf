locals {
  # lambda_functions = ["Lambda-1", "Lambda-2", "Lambda-3"]
  # sqs_queue_names = ["Queue-1", "Queue-2", "Queue-3"]
  lambda_functions = ["CreateThumbnail", "CreateMobileImage", "CreateWebImage"]
  ...
  ssl_certificate_id              = local.enviroment == "failover" ? "9a011615-caf2-406e-af78-fb753c55e4cb" : "33a2a3c4-f3b0-47e9-8b07-b112f4fc5f00"
  api_gateway_ssl_certificate_arn = "arn:aws:acm:${local.region}:405241045532:certificate/f9b96670-37aa-409a-be1c-d17a716455a3"
}
...
## Create S3 bucket replication role and attach needed policies
...
## Create Lambda functions for images.
